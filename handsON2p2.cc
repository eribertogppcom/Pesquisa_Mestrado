...
main (int argc, char *argv[])
{
  ...
  cmd.Parse (argc,argv);  //Linha que habilita a alteração do código via CLI comando PARSE
...
UdpEchoClientHelper echoClient2 (p2pInterfaces.GetAddress (0), 7);
  ...
  pointToPoint.EnablePcapAll ("handsON2p2"); //Habilitando o rastreamento pcap P2P
  csma.EnablePcap ("handsON2p2", csmaDevices.Get (1), true); //Habilitando o rastreamento pcap nś csma
